...
<section class="login-content">
  ...
  <div class="login-box">
    <form class="login-form" name="formLogin" id="formLogin" action="">
      <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user mr-2"></i>INICIAR SESION</h3>
      ...
      <div class="form-group btn-container">
        <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-sign-in-alt fa-lg mr-2"></i>INICIAR SESION</button>
      </div>
    </form>
...
<script src="<?= media(); ?>/js/alertas.js"></script>
