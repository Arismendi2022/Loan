			...
			<div class="modal-body">
				<form id="formPerfil" name="formPerfil" class="form-horizontal">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control valid validNumber" id="txtIdentificacion" name="txtIdentificacion"
							       value="<?= $_SESSION['userData']['identificacion']; ?>" required="" onkeypress="return controlTag(event);">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
					...
					<div class="tile-footer">
						<button id="btnActionForm" class="btn btn-info" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i><span
											id="btnText">Actualiza</span></button>&nbsp;&nbsp;&nbsp;
